...
TEXTS = {
    'en': {
        ...
        'enter_ssh_key': "Send me the SSH key (file or just paste it):",
        ...
        # Success messages
        'operation_successful': "✅ All done! That went perfectly!",
        'node_reconnected': "🔄 Your node is back online and happy!",
        'node_deleted': "🗑️ Node removed successfully!",
        'node_updated': "🔄 Node info is fresh and updated!",
    },
    ...
    'fa': {
        ...
        'enter_ssh_key': "کلید SSH رو بفرست (فایل یا کپی کن):",
        ...
        # Success messages
        'operation_successful': "✅ تمام! همه چیز عالی پیش رفت!",
        'node_reconnected': "🔄 نودت برگشت و حالش خوبه!",
        'node_deleted': "🗑️ نود با موفقیت حذف شد!",
        'node_updated': "🔄 اطلاعات نود بروز شد!",
    },
    ...
    'ru': {
        ...
        'enter_ssh_key': "Пришли SSH ключ (файлом или текстом):",
    ...
    'ar': {
        ...
        'enter_ssh_key': "أرسل مفتاح SSH (كملف أو انسخه):",
