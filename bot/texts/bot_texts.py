...
TEXTS = {
    ...
    'fa': {
        ...
        'list_nodes': "📋 لیست همه نود ها",
        'get_node_info': "ℹ️ جزئیات نود",
        'add_new_node': "➕ افزودن نود",
        ...
        'port_config': "حالا پورت‌ها رو تنظیم کنیم!(منسوخ)",
        'custom_ports': "⚙️ خودم پورت انتخاب می‌کنم(منسوخ)",
        'random_ports': "🎲 هر چی شد!(منسوخ)",
        'enter_node_port': "پورت نود:(منسوخ)",
        'enter_api_port': "پورت API:(منسوخ)",
        'enter_node_name': "چه اسمی براش بذاریم؟",
        'random_name': "🎲 اسم تصادفی انتخاب کن",
        'installing_node': "🚀 دارم نودت رو نصب می‌کنم... یه چایی بخور! ☕ (۲ دقیقه معمولا طول میکشه)",
