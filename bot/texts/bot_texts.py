...
TEXTS = {
    'en': {
        ...
        'installation_warning': "⚠️ IMPORTANT: Do not send any messages to the bot during installation!",
        'installing_node_progress': "🚀 Installing your node... {progress}% complete ☕",
        
        # Bulk installation
        'enter_bulk_servers': "📋 Enter server list (one per line):\nFormat: IP USERNAME [PORT]\nExample:\n192.168.1.1 root\n192.168.1.2 admin 2222",
        'enter_bulk_password': "🔒 Enter the password for all servers:",
        'enter_bulk_ssh_key': "🔑 Enter the SSH key for all servers:",
        'bulk_installation_start': "🚀 Starting bulk installation for {count} servers...",
        'installing_server': "📦 Installing server {current}/{total}: {ip}",
        'server_installed_success': "✅ Server {ip} installed successfully!",
        'server_installation_failed': "❌ Server {ip} failed: {error}",
        'bulk_installation_complete': "🎉 Bulk installation completed!",
        'invalid_server_format': "❌ Invalid server format! Please check the format.",
        
        # Server monitoring
        'node_servers': "🖥️ Node Servers",
        'servers_list': "🖥️ Your node servers:",
        'no_servers': "🤷‍♂️ No servers found. Install some nodes first!",
        'server_info': "🖥️ Live Server Information",
        'server_not_found': "❌ Server not found!",
        'refresh': "Refresh",
        
        # Backup restore
        'backup_restore': "💾 Backup & Restore",
        'backup_restore_menu': "💾 Backup & Restore Management",
        'upload_backup': "📤 Upload Backup",
        'upload_backup_file': "📤 Please upload your .db backup file:",
        'backup_merge_choice': "🔄 How should I handle the backup?\n\nType 'merge' to combine with current data\nType 'replace' to replace all current data",
        'backup_restored_merge': "✅ Backup merged successfully!",
        'backup_restored_replace': "✅ Backup restored (data replaced)!",
        'invalid_backup_file': "❌ Invalid backup file! Please upload a .db file.",
